...
module.exports = {
  ...
  entry: {
    ...
    assets: ["assets",],
    d3: ["d3-array", "d3-request", "d3-scale"],
    react: [
      "styled-components", "styled-system", 
      "styled-theme", "react-map-gl", 'recompose',
      'react-big-calendar', 'react-perfect-scrollbar', 'redux-saga', 'redux-form',
      'ory-editor-core', 'ory-editor-plugins-default-native', 'ory-editor-plugins-slate', 'ory-editor-plugins-spacer', 'ory-editor-ui' 
      ],
    vendor: ["lodash", "material-ui", "moment", "firebase"],
  },
  output: {
    path: paths.appBuild,
